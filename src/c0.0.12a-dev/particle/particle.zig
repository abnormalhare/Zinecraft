...
pub const Particle = struct {
    ...
    pub fn init(level: *Level, rand: *std.Random, x: f32, y: f32, z: f32, xa: f32, ya: f32, za: f32, tex: i32) Particle {
        ...
        return Particle{
            ...
            .age = 0,
            .lifetime = @intFromFloat(4.0 / (rand.float(f64) * 0.9 + 0.1)),
            .size = @floatCast(rand.float(f64) * 0.5 + 0.5),
        };
    }
    ...
    pub fn tick(self: *Particle, alloc: std.mem.Allocator) !void {
        ...
        self.yd = @floatCast(@as(f64, self.yd) - 0.04);
    ...
    pub fn render(self: *const Particle, t: *Tesselator, a: f32, xa: f32, ya: f32, za: f32, xa2: f32, za2: f32) void {
        const entity = &self.entity;
        ...
        t.vertex_uv(x - xa * r - xa2 * r, y - ya * r, z - za * r - za2 * r, um0, v1);
        t.vertex_uv(x - xa * r + xa2 * r, y + ya * r, z - za * r + za2 * r, um0, v0);
        t.vertex_uv(x + xa * r + xa2 * r, y + ya * r, z + za * r + za2 * r, um1, v0);
        t.vertex_uv(x + xa * r - xa2 * r, y - ya * r, z + za * r - za2 * r, um1, v1);
    }
};
