...
const Bush = @import("bush.zig").Bush;
...
pub const bush: Tile = .{ .bush = Bush.init(6) };
...
pub const GenericTile = struct {
    ...
    pub fn get_aabb(self: *const GenericTile, x: i32, y: i32, z: i32) AABB {
        _ = self;
        return AABB{
            .x0 = @floatFromInt(x),
            .y0 = @floatFromInt(y),
...
pub const Tile = union(enum) {
    ...
    pub fn get_tile_aabb(self: Tile, x: i32, y: i32, z: i32) AABB {
        _ = self;
        return AABB{
            .x0 = @floatFromInt(x),
            .y0 = @floatFromInt(y),
    ...
    pub fn get_aabb(self: Tile, x: i32, y: i32, z: i32) ?AABB {
        return switch (self) {
            .normal => |n| n.get_aabb(x, y, z),
            .dirt => |d| d.get_aabb(x, y, z),
            .grass => |g| g.get_aabb(x, y, z),
            .bush => |b| b.get_aabb(),
        };
    }
