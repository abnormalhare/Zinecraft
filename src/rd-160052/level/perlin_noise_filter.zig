...
pub const PerlinNoiseFilter = struct {
    rand: *std.Random,
    seed: i32,
    levels: i32,
    fuzz: i32,

    pub fn new(rand: *std.Random, levels: i32) PerlinNoiseFilter {
        return PerlinNoiseFilter{
            .rand = rand,
            .seed = rand.int(i32),
            .levels = levels,
            .fuzz = 16,
    ...
    pub fn read(self: *PerlinNoiseFilter, alloc: std.mem.Allocator, width: i32, height: i32) ![]i32 {
